 ...
 * </pre>
 *
 * Protobuf type {@code com.menu.grpc.MenuResponse}
 */
public  final class MenuResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:com.menu.grpc.MenuResponse)
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 42: {
            if (!((mutable_bitField0_ & 0x00000020) == 0x00000020)) {
              menu_ = new java.util.ArrayList<com.menu.grpc.Menu>();
              mutable_bitField0_ |= 0x00000020;
            }
            menu_.add(
                input.readMessage(com.menu.grpc.Menu.parser(), extensionRegistry));
            break;
          }
          case 48: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.menu.grpc.MenuOuterClass.internal_static_com_menu_grpc_MenuResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.menu.grpc.MenuOuterClass.internal_static_com_menu_grpc_MenuResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.menu.grpc.MenuResponse.class, com.menu.grpc.MenuResponse.Builder.class);
  }
  ...
  private java.util.List<com.menu.grpc.Menu> menu_;
  /**
   * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
   */
  public java.util.List<com.menu.grpc.Menu> getMenuList() {
    return menu_;
  }
  /**
   * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
   */
  public java.util.List<? extends com.menu.grpc.MenuOrBuilder> 
   ...
   * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
   */
  public com.menu.grpc.Menu getMenu(int index) {
    return menu_.get(index);
  }
  /**
   * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
   */
  public com.menu.grpc.MenuOrBuilder getMenuOrBuilder(
      int index) {
    return menu_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.menu.grpc.MenuResponse)) {
      return super.equals(obj);
    }
    com.menu.grpc.MenuResponse other = (com.menu.grpc.MenuResponse) obj;
  ...
  public static com.menu.grpc.MenuResponse parseFrom(
  ...
  public static com.menu.grpc.MenuResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.menu.grpc.MenuResponse parseFrom(
  ...
  public static com.menu.grpc.MenuResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.menu.grpc.MenuResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.menu.grpc.MenuResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.menu.grpc.MenuResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:com.menu.grpc.MenuResponse)
      com.menu.grpc.MenuResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.menu.grpc.MenuOuterClass.internal_static_com_menu_grpc_MenuResponse_descriptor;
    }
    ...
    // Construct using com.menu.grpc.MenuResponse.newBuilder()
    private Builder() {
    ...
    public com.menu.grpc.MenuResponse getDefaultInstanceForType() {
      return com.menu.grpc.MenuResponse.getDefaultInstance();
    }

    public com.menu.grpc.MenuResponse build() {
      com.menu.grpc.MenuResponse result = buildPartial();
    ...
    public com.menu.grpc.MenuResponse buildPartial() {
      com.menu.grpc.MenuResponse result = new com.menu.grpc.MenuResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.menu.grpc.MenuResponse) {
        return mergeFrom((com.menu.grpc.MenuResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.menu.grpc.MenuResponse other) {
      if (other == com.menu.grpc.MenuResponse.getDefaultInstance()) return this;
      if (other.getId() != 0) {
        setId(other.getId());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.menu.grpc.MenuResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.menu.grpc.MenuResponse) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureMenuIsMutable() {
      if (!((bitField0_ & 0x00000020) == 0x00000020)) {
        menu_ = new java.util.ArrayList<com.menu.grpc.Menu>(menu_);
        bitField0_ |= 0x00000020;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.menu.grpc.Menu, com.menu.grpc.Menu.Builder, com.menu.grpc.MenuOrBuilder> menuBuilder_;
    ...
    public Builder setMenu(
        int index, com.menu.grpc.Menu value) {
      if (menuBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setMenu(
        int index, com.menu.grpc.Menu.Builder builderForValue) {
      if (menuBuilder_ == null) {
        ensureMenuIsMutable();
     ...
     * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
     */
    public Builder addMenu(com.menu.grpc.Menu value) {
      if (menuBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addMenu(
        com.menu.grpc.Menu.Builder builderForValue) {
      if (menuBuilder_ == null) {
        ensureMenuIsMutable();
    ...
    public Builder addAllMenu(
        java.lang.Iterable<? extends com.menu.grpc.Menu> values) {
      if (menuBuilder_ == null) {
        ensureMenuIsMutable();
     ...
     * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
     */
    public com.menu.grpc.Menu.Builder getMenuBuilder(
        int index) {
     ...
     * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
     */
    public com.menu.grpc.Menu.Builder addMenuBuilder() {
      return getMenuFieldBuilder().addBuilder(
          com.menu.grpc.Menu.getDefaultInstance());
    }
    /**
     * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
     */
    public com.menu.grpc.Menu.Builder addMenuBuilder(
        int index) {
      return getMenuFieldBuilder().addBuilder(
          index, com.menu.grpc.Menu.getDefaultInstance());
    }
    /**
     * <code>repeated .com.menu.grpc.Menu menu = 5;</code>
     */
    public java.util.List<com.menu.grpc.Menu.Builder> 
         getMenuBuilderList() {
      return getMenuFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.menu.grpc.Menu, com.menu.grpc.Menu.Builder, com.menu.grpc.MenuOrBuilder> 
        getMenuFieldBuilder() {
      if (menuBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:com.menu.grpc.MenuResponse)
  }

  // @@protoc_insertion_point(class_scope:com.menu.grpc.MenuResponse)
  private static final com.menu.grpc.MenuResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.menu.grpc.MenuResponse();
  }

  public static com.menu.grpc.MenuResponse getDefaultInstance() {
